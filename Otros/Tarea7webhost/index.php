...
<section class="principal">
    ...
    if (isset($_GET["action"]) && isset($_GET["id"]) && $_GET["action"] == "get_datos_autor") {
                ...
                <ul>
                    ...
                    <?php foreach ($app_info->libros as $libros): ?>
                        <li>
                            ...
                            <a
                                href="<?php echo "http://tarea4aitorgil.000webhostapp.com/index.php?action=get_datos_libro&id=" . $libros->id ?>">
        ...
        <a class="enlaceVolver" href="http://tarea4aitorgil.000webhostapp.com/index.php?action=get_listado_autores"
        ...
        <section class="englobaDescripcion">
            ...
            <a class="datosAutor" href="http://tarea4aitorgil.000webhostapp.com/index.php?action=get_datos_autor&id=<?php echo $app_info->idAutor ?>"
            ...
            <section class="centro">
            <a class="enlaceVolver" href="http://tarea4aitorgil.000webhostapp.com/index.php?action=get_listado_libros" alt="Lista de libros">Volver a
                ...
                <section class="autores">
                    ...
                    <?php foreach ($lista_autores as $autores): ?>
                            <li>
                                <!-- Enlazamos cada nombre de autor con su informacion (primer if) -->
                                <a
                                    href="<?php echo "http://tarea4aitorgil.000webhostapp.com/index.php?action=get_datos_autor&id=" . $autores->id ?>">
